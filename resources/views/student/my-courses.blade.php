...
@section('header')
    <x-ui.page-header title="My Courses" subtitle="Your programme curriculum and enrolled courses" />
@endsection

@section('content')
<div class="mx-auto max-w-7xl px-4 py-6 sm:px-6">

    @if (!$student || !$academicProgramme)
        <div class="rounded-2xl border border-dashed border-border bg-raised/40 p-12 text-center">
            ...
            <h3 class="mt-4 text-lg font-bold text-text">No programme linked</h3>
            <p class="mt-2 text-sm text-muted">Your account doesn't have a programme assigned yet. Contact your institution administrator to link your programme.</p>
            ...
            <div class="mb-8">
                ...
                <div class="grid gap-4 lg:grid-cols-2 xl:grid-cols-3">
                    @foreach ($activeEnrollments as $cc)
                        ...
                        <a href="{{ $offering ? route('courses.show', $offering) : '#' }}" class="group block rounded-xl border border-border bg-surface/80 p-5 shadow-sm transition hover:border-primary/30 hover:shadow-md hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-ring">
